...
<div class="kiri">
            <form action="puspendik.php" method="post">    
                            ...
                            <div class="list-group-item">
                                ...
                                <p class="list-group-item-text"><?php echo "$val_siswa"; ?><br><?php echo "($xkodekelas-$xjurz | $xnamkel)"; ?></p>
                                <input id="NamaPeserta" name="NamaPeserta" type="hidden" value="">
                            </div>
                            <div class="list-group-item">
                                <label class="list-group-item-heading">Mata Uji Tes  -  Token</label>
                                <p class="list-group-item-text"><?php echo "$xnamamapel"; ?> <?php echo "- [ $xtokenujian ]"; ?></p>
...
<footer>
    <div  style=" background-color:<?php echo "$r[XWarna]"; ?>; padding:7px; font-size:12px"">
        <p><b><span style="color: #ff0000;"><?php echo strtoupper("$r[XSekolah]"); ?> </b>| <span style="color: #1B06CF;">Supported by BEESMART</span></p>
    </div>
</footer>
-->
