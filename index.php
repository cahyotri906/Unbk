...
<nav class="navbar navbar-default" style="background-color:#F7FACD">
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li><a href="./panel/pages/index.php">Login Admin UNBK</a></li>
...
<a href="./panel/pages/index.php"><button type="button" class="btn btn-primary btn-small">Login Admin UNBK</button></a>
