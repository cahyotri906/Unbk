...
header("Location: logout.php");
	...
	if ($_COOKIE['beelogin']=="siswa"){
		$res = mysql_fetch_array(mysql_query("select * from cbt_siswa WHERE XNomerUjian='$_COOKIE[beeuser]'"));
		$poto  = $res['XFoto']; 
		$nama = $res['XNamaSiswa'];
		$loginx="3";
	}else{
...
<script type="text/javascript" src="../../panel/pages/js/jquery-1.4.js"></script>
<link rel="stylesheet" type="text/css" href="../../panel/pages/css/jquery.datetimepicker.css"/>
<style type="text/css">
	.custom-date-style {background-color: red !important;}
	.input{	}
	.input-wide{width: 500px;}
</style>
<script src="../../panel/pages/date/jquery.js"></script>
<script src="../../panel/pages/js/jquery.datetimepicker.full.js"></script>
<script>
...
<header>
	<nav class="navbar navbar-default" >
			<div class="navbar-header" style="width:100%;  background-color:<?php echo $skul_warna; ?>; ">
				<a class="navbar-header" ><img alt="Brand" src="../../images/<?php echo $skul_ban; ?>"></a>
				<ul class="nav navbar-nav navbar-right">
					<li class="navbar-toggle collapsed" style="background-color:#e4e4e2;">
						<a href="#" style="background-color:#F8FFBF;" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
...
<!-- //////// ADMIN (1) ////////  -->	
	...
	<div id="page-wrapper"><!-- page wrapper -->
		<?php	if(isset($_REQUEST['modul'])==""){include "none.php";}	
				...
				elseif($_REQUEST['modul']=="jawabanesai_siswa"){include "jawabanesai_siswa.php";}	
						...
						<div class="inner-content">
							<div class="wysiwyg-content">
								...
								<p align="center"> <br><b>BeeSMART</b> on Internet : <br>							
									<br><a href="https://www.youtube.com/watch?v=aceevCaKKH8&list=PLaRJCwMbrhIIj44b9JY08hf9C-FyJMtEt" target="_blank"><img src="../../panel/pages/images/youtube.png" width="60"></a> 
										&nbsp;&nbsp;&nbsp;&nbsp; 
										<a href="https://t.me/joinchat/AAAAAAtB2PtpcsPMaFEuKQ" target="_blank"><img src="../../panel/pages/images/telegram.png" width="30"></a> 
										&nbsp;&nbsp;&nbsp;&nbsp; 
										<a href="https://www.facebook.com/BSMARTLabs/" target="_blank"><img src="../../panel/pages/images/fb.png" width="30"> </a> 
										&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <p>	<table width="100%">
            ...
            <tr height="30px"><td width="30%">Sesi </td><td>: <td>
                <select class="form-control" id="sesi1"  name="sesi1">
					<?php	$sqk = mysql_query("select * from cbt_siswa group by XSesi");
            ...
            <tr height="30px"><td width="30%">Ruang </td><td>: <td>
                <select class="form-control" id="ruang1"  name="ruang1">
					<?php	$sqk = mysql_query("select * from cbt_siswa group by XRuang");
...
<form action="?modul=cetak_TO" method="post">
    ...
    <div class="wysiwyg-content">
        <p><table width="100%">
			<tr height="40px"><td>Jenis Tes</td><td>:  &nbsp;&nbsp;<td>                                  
                <select class="form-control" id="tes3"  name="tes3">
					<?php	$sqk = mysql_query("select * from cbt_tes"); echo "<option value='TO' >Try Out</option>"; ?>                                
                </select>
			</td></tr>        
            <tr height="40px"><td width="30%">Semester</td><td>:<td>   
                <select class="form-control" id="sem3"  name="sem3">
...
<script src="../../panel/vendor/raphael/raphael.min.js"></script>
<script src="../../panel/vendor/morrisjs/morris.min.js"></script>
<script src="../../panel/data/morris-data.js"></script>
...
<script src="../../panel/vendor/datatables-plugins/dataTables.bootstrap.min.js"></script>
<script src="../../panel/vendor/datatables-responsive/dataTables.responsive.js"></script>