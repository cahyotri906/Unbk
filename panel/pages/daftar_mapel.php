...
<body>
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Daftar Mata Pelajaran</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
				...
				<a href="down_excel_mapel.php" target="_blank">
					<button type="button" class="btn btn-success" id="download"> <i class='fa fa-cloud-download  '></i> Download Data Mapel</button>
				</a>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								?>
                                    ...
                                    <tr class="odd gradeX">
                                        <td align="center" input type="hidden" value="<?php echo $s['Urut']; ?>" id="txt_mapel<?php echo $s['Urut']; ?>"><?php echo $no; ?></td>
                                        <td align="center"><?php echo $s['XKodeSekolah']; ?></td>
										<td align="center"><?php echo $s['XKodeMapel']; ?></td>
                                        <td><?php echo $s['XNamaMapel']; ?></td>
                                        <td align="center"><?php echo $s['XPersenUH']; ?></td> 
                                        <td align="center"><?php echo $s['XPersenUTS']; ?></td>
                                        <td align="center"><?php echo $s['XPersenUAS']; ?></td>
                                        <td align="center"><?php echo $s['XKKM']; ?></td>      
                                        <td align="center"><?php echo $s['XMapelAgama']; ?></td>                      
