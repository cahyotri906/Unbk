...
if(isset($_REQUEST['upl'])){ 
	$sqlnilai = mysql_query("select * from cbt_nilai where XTokenUjian = '$_REQUEST[token]' AND XStatus='1'");
...
?>                            
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover">
                                ...
                                <?php   
								include "../../config/server.php";
								$sql5 = mysql_query("SELECT n.*,s.*,k.*,s.XKodeKelas as XKodeKelas, n.XNomerUjian as XNomerUjian
